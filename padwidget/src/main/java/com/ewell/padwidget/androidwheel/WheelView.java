...
package com.ewell.padwidget.androidwheel;
...
import com.ewell.padwidget.androidwheel.adapters.WheelViewAdapter;
...
public class WheelView extends View {
	...
	//*/
	private int[] SHADOWS_COLORS = new int[] { 0x77FFFFFF,
			0x44FFFFFF, 0x22FFFFFF };

package com.ewell.padwidget.verticaltablayout;
...
import com.ewell.padwidget.verticaltablayout.widget.QTabView;
import com.ewell.padwidget.verticaltablayout.widget.TabIndicator;
import com.ewell.padwidget.verticaltablayout.widget.TabView;
...
/**
 * 竖直方向的tablayout，网上github上的 https://github.com/qstumn/VerticalTabLayout
 * @author chqiu
...
public class VerticalTabLayout extends ScrollView {
    ...
    public VerticalTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mColorIndicator = typedArray.getColor(R.styleable.VerticalTabLayout_indicator_color,
                context.getResources().getColor(R.color.vertical_indicator));

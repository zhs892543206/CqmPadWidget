...
package com.ewell.padwidget.Timewheelview;
...
public class TimeWheelView extends View {
	...
	private static int VALUE_TEXT_COLOR = 0xCD5C5CFF;//蓝色,初始化initData时重新设置下为titlebackground
	...
	private void initData(Context context) {
		...
		VALUE_TEXT_COLOR = getResources().getColor(R.color.title_bg);
	}

...
import com.ewell.padwidget.gridbuilder.calculator.PositionCalculator;
import com.ewell.padwidget.gridbuilder.listener.OnItemClickListener;
import com.ewell.padwidget.gridbuilder.listener.OnItemSelectedListener;
import com.ewell.padwidget.gridbuilder.listener.OnViewCreateCallBack;
import com.ewell.padwidget.gridbuilder.utils.BitmapUtils;
...
public class GridBuilder implements View.OnFocusChangeListener, View.OnClickListener {
     ...
     */
    private GridBuilder addItem(final GridItem gridItem) {
        ...
        itemLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mOnViewCreateCallBack.onClickDeal(gridItem);
            }
        });
